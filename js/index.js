...
const popupCloseButtonEdit = popupProfileEdit.querySelector('.popup__button-close');
...
const popupCloseButtonShow = popupCardShow.querySelector('.popup__button-close');
